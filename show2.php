...
if (!empty($_SESSION['cart'])) {
    ...
    echo '<div class="row mt-5" data-bs-theme="dark"><div class="col-sm-4 mx-auto"><div class="card bg-black mb-3"><div class="card-header text-orange0"><h3 class="card-title fw-bolder">Booking Summary</h3></div><div class="card-body"><form action="show2.php" method="post">';
